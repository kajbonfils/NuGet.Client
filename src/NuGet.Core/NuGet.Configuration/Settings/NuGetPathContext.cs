...
namespace NuGet.Configuration
{
    public class NuGetPathContext : INuGetPathContext
    {
        ...
        /// </summary>
        public IReadOnlyList<string> FallbackPackagesFolders { get; internal set; }

        /// <summary>
        /// User global packages folder.
        /// </summary>
        public string UserPackagesFolder { get; internal set; }
        ...
        public static NuGetPathContext Create(ISettings settings)
        {
            ...
            {
                FallbackPackagesFolders = SettingsUtility.GetFallbackPackagesFolders(settings),
                UserPackagesFolder = SettingsUtility.GetGlobalPackagesFolder(settings),
